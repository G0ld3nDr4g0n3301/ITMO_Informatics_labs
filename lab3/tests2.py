...
tests = {
	...
	'3': [['Когда же закончится это? / Или уже отчислят меня? / Не хочу отчисления!','К горе уехал / Наебнулся с горы я! / Очень Мудрый я.','Привет'],['Не хайку.','Хайку!','Не хайку.Должно быть 3 строки.']],
